...
from KRK_Forum.common.mixins import MenuItemMixin
...
class UserAccountParametersUpdateView(MenuItemMixin, UpdateView):
    ...
    def form_valid(self, form):
        messages.success(self.request, _('A fiókod sikeresen frissitve!'))
...
class UserPasswordUpdateView(MenuItemMixin, FormView):
    ...
    def form_valid(self, form):
        form.save()
        messages.success(self.request, _('A jelszavad sikeresen frissitve'))
...
class UserDeleteView(MenuItemMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        user.delete()
        logout(self.request)
        messages.success(self.request, _('A fiókod törölve lett.'))
