...
class AbstractAttachment(models.Model):
    ...
    file = models.FileField(upload_to=get_attachment_file_upload_to, verbose_name=_('Fájl'))
    comment = models.CharField(max_length=255, verbose_name=_('Komment'), blank=True, null=True)
