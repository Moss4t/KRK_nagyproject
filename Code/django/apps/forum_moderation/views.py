...
class TopicLockView(PermissionRequiredMixin, SingleObjectTemplateResponseMixin, BaseDetailView):
    ...
    model = Topic
    success_message = _('A bejegyzés sikeresen zárolva.')
...
class TopicUnlockView(PermissionRequiredMixin, SingleObjectTemplateResponseMixin, BaseDetailView):
    ...
    success_message = _('A bejegyzés sikeresen feloldva.')
...
class TopicDeleteView(PermissionRequiredMixin, DeleteView):
    ...
    context_object_name = 'topic'
    model = Topic
    success_message = _('A bejegyzés sikeresen törölve.')
...
class TopicMoveView(
    ...
    model = Topic
    success_message = _('A bejegyzés sikeresen áthelyezve.')
...
class TopicUpdateToNormalTopicView(TopicUpdateTypeBaseView):
    ...
    question = _('Szeretnéd ezt a bejegyzést normál tipusba helyezni?')
...
class TopicUpdateToStickyTopicView(TopicUpdateTypeBaseView):
    ...
    question = _('Szeretnéd ezt a bejegyzést kiemelté tenni?')
...
class TopicUpdateToAnnounceView(TopicUpdateTypeBaseView):
    ...
    question = _('Szeretnéd ezt a bejegyzést közleménnyé tenni?')
...
class PostApproveView(PermissionRequiredMixin, SingleObjectTemplateResponseMixin, BaseDetailView):
    ...
    context_object_name = 'post'
    model = Post
    success_message = _('A bejegyzést sikeresen engedélyezted.')
...
class PostDisapproveView(
    ...
    context_object_name = 'post'
    model = Post
    success_message = _('A bejegyzést sikeresen nem engedélyezted.')
