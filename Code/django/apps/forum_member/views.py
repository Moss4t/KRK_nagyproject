...
class ForumProfileUpdateView(LoginRequiredMixin, UpdateView):
    ...
    success_message = _('Profil sikeresen szerkesztve.')
...
class TopicSubscribeView(
    ...
    model = Topic
    success_message = _('Sikeresen feliratkoztál a bejegyzésre.')
...
class TopicUnsubscribeView(
    ...
    model = Topic
    success_message = _('Sikeresen leiratkoztál a bejegyzésről.')
