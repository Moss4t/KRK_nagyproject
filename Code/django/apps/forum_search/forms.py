...
class SearchForm(FacetedSearchForm):
    ...
    search_topics = forms.BooleanField(label=_('Bejegyzés tárgyában keresés csak'), required=False)

    search_poster_name = forms.CharField(
        label=_('Posztoló felhasználó'),
        help_text=_('Felhasználó nevéd ird be erre a helyre.'),
        max_length=255, required=False,
    )

    search_forums = forms.MultipleChoiceField(
        label=_('Specifikus témába való keresés'),
        help_text=_('Válaszd ki a témákat amiben keresni szeretnél'),
        required=False,
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Update some fields
        self.fields['q'].label = _('Kulcs szavakra való keresés')
        self.fields['q'].widget.attrs['placeholder'] = _('Szavak vagy kifejezések')
        self.fields['search_poster_name'].widget.attrs['placeholder'] = _('Posztoló felhasználó neve')
