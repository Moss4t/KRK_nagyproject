...
class ExtendedImageField(models.ImageField):
    ...
    def clean(self, *args, **kwargs):
        ...
        if self.max_upload_size and hasattr(image, 'size'):
            if image.size > self.max_upload_size:
                raise ValidationError(
                    _('A fálj mérete nem megfelelő {} ez a méret nem engedélyezett. Fájlod mérete: {}').format(
        ...
        if self.min_width and self.max_width \
            ...
            raise ValidationError(
                _('A képed szélessége kisebb mint {}px vagy nagyobb mint {}px ezért nem engedélyezett. '
                  'A képed szélessége: {}px').format(
        ...
        if self.min_height and self.max_height \
            ...
            raise ValidationError(
                _('A képed magassága kisebb mint {}px vagy nagyobb mint {}px ezért nem engedélyezett. '
                  'A képed magassága: {}px').format(
